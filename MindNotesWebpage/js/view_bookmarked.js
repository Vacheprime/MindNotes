let notepages = JSON.parse(localStorage.getItem("NotePages")).filter(p => p.bookmarked);
if (notepages == null) {
	notepages = [];
}
...
function onCategoryChange() {
	const allNotepages = JSON.parse(localStorage.getItem("NotePages")).filter(p => p.bookmarked);
